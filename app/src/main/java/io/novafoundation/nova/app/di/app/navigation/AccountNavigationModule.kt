...
import io.novafoundation.nova.app.root.navigation.account.PolkadotVaultSignCommunicatorImpl
...
class AccountNavigationModule {
    ...
    @Provides
    @ApplicationScope
    fun providePolkadotVaultCommunicator(
        navigationHolder: NavigationHolder
    ): PolkadotVaultSignCommunicator = PolkadotVaultSignCommunicatorImpl(navigationHolder)
