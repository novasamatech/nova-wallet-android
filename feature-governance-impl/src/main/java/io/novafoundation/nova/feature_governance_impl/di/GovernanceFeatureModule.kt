...
import io.novafoundation.nova.feature_governance_impl.di.modules.VGovernanceV2Module
...
@Module(includes = [VGovernanceV2Module::class, GovernanceUpdatersModule::class])
