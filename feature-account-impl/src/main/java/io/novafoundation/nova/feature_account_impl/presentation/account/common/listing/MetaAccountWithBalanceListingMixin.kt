...
@FeatureScope
class MetaAccountWithBalanceListingMixinFactory @Inject constructor(
...
private class MetaAccountWithBalanceListingMixin(
    ...
    private fun MetaAccountListingItem.chainIcon(): Icon? {
        return when (this) {
            ...
            is MetaAccountListingItem.Derivative -> singleChain?.iconOrFallback()
    ...
    private suspend fun MetaAccountListingItem.formatSubtitle(): CharSequence = when (this) {
        ...
        is MetaAccountListingItem.Derivative -> formatSubtitle()
    }

    private suspend fun MetaAccountListingItem.Proxied.formatSubtitle(): CharSequence {
        return proxyFormatter.formatProxiedMetaAccountSubtitle(proxyMetaAccount, metaAccount.proxy)
    }
    ...
    private suspend fun MetaAccountListingItem.Derivative.formatSubtitle(): CharSequence {
        return derivativeFormatter.formatDeriveAccountSubtitle(metaAccount, parent)
    }
    ...
    private fun MetaAccount.isEditable(): Boolean {
        return when (type) {
            ...
            LightMetaAccount.Type.DERIVATIVE -> false
        }
    }
}
