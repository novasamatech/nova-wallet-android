...
interface FractionStylingFormatter {
    ...
    fun formatFraction(unformattedAmount: CharSequence, @DimenRes floatAmountSize: Int): CharSequence
}
...
class RealFractionStylingFormatter(
    ...
    override fun formatFraction(unformattedAmount: CharSequence, @DimenRes floatAmountSize: Int): CharSequence {
