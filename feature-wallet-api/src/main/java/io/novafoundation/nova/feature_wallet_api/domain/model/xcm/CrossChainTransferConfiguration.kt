...
sealed interface CrossChainTransferConfiguration : CrossChainTransferConfigurationBase {
    ...
    class Legacy(val config: LegacyCrossChainTransferConfiguration): CrossChainTransferConfiguration,
        CrossChainTransferConfigurationBase by config

    class Dynamic(val config: DynamicCrossChainTransferConfiguration): CrossChainTransferConfiguration,
        CrossChainTransferConfigurationBase by config
}
