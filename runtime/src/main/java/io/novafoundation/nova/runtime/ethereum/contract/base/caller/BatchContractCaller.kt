...
import io.novafoundation.nova.core.updater.wssEthereumApi
...
class BatchContractCaller(
    ...
    override fun ethCall(transaction: Transaction, defaultBlockParameter: DefaultBlockParameter): CompletableFuture<EthCall> {
        val request = ethereumSharedRequestsBuilder.wssEthereumApi.ethCall(transaction, defaultBlockParameter)
