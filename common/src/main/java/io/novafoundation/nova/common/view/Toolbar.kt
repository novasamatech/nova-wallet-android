...
class Toolbar @JvmOverloads constructor(
    ...
    private fun applyAttributes(attrs: AttributeSet?) {
        attrs?.let {
            ...
            val backgroundAttrDrawable = typedArray.getDrawable(R.styleable.Toolbar_contentBackground) ?: ColorDrawable(context.getColor(R.color.secondary_screen_background))
