...
import io.novafoundation.nova.common.data.network.runtime.binding.BinderWithType
...
import io.novafoundation.nova.feature_staking_impl.data.network.blockhain.bindings.bindTotalValidatorEraReward
        ...
        return when (stakingState) {
            is StakingState.Stash.Nominator -> calculateUnpaidPayouts(
                ...
                retrieveValidatorAddresses = {
                    validatorSetFetcher.fetchAllValidators(stakingState.chain, stakingState.stashAddress)
                },
