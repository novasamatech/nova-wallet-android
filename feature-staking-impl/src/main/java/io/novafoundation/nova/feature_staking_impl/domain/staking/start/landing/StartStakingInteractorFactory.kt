...
import io.novafoundation.nova.feature_staking_impl.domain.staking.start.common.types.direct.ParachainStakingTypeDetailsInteractor
import io.novafoundation.nova.feature_staking_impl.domain.staking.start.common.types.direct.RelaychainStakingTypeDetailsInteractor
...
class StartStakingInteractorFactory(
    ...
    private fun createRelaychainStartStakingInteractor(coroutineScope: CoroutineScope, stakingOption: StakingOption): StakingTypeDetailsInteractor {
    ...
    private fun createNominationPoolsStartStakingInteractor(coroutineScope: CoroutineScope, stakingOption: StakingOption): StakingTypeDetailsInteractor {
        return NominationPoolStakingTypeDetailsInteractor(
            stakingOption = stakingOption,
