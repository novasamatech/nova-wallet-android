...
private fun XcmV2.toEncodableInstance(): Any = instructions.map { it.toEncodableInstance(XcmVersion.V2) }
...
private fun XcmV2Instruction.toEncodableInstance(xcmVersion: XcmVersion) = when (this) {
