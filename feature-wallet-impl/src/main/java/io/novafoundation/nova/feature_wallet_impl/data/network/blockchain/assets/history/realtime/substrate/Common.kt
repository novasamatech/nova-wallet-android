...
suspend fun List<GenericEvent.Instance>.assetFee(multiLocationConverter: ChainAssetLocationConverter, pov: Chain): ChainAssetWithAmount? {
    ...
    val chainAsset = multiLocationConverter.chainAssetFromRelativeLocation(bindMultiLocation(assetId), pov) ?: return null
