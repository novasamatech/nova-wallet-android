...
class SwapDetailViewModel(
    ...
    val amountModel = flowOfAll {
        val source = if (operation.amountIsAssetIn) assetInModel else assetOutModel

        source.map { it.amount }
    }.shareInBackground()
    ...
    private suspend fun createAssetSwapModel(
        ...
        return SwapAssetView.Model(
            ...
            amount = mapAmountToAmountModel(amount, token),
