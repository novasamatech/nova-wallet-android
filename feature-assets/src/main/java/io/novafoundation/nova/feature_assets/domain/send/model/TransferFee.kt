...
data class TransferFee(
    ...
    val postSubmissionFee: PostSubmissionAmountFee?
    ...
    fun totalFeeByExecutingAccount(chainAsset: Chain.Asset): Balance {
        ...
        val delivery = originFee.postSubmissionFeeByAccount?.getAmount(chainAsset, accountThatPaysFees).orZero()
    ...
    override fun maxAmountDeductionFor(amountAsset: Chain.Asset): Balance {
        ...
        val delivery = originFee.postSubmissionFeeByAccount?.getAmount(amountAsset).orZero()
        ...
        val execution = postSubmissionFee?.totalFee?.getAmount(amountAsset).orZero()
